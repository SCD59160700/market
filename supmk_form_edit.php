      ...
      <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="supmaeket.php">จัดการข้อมูลตลาด</a>
          </div>
        </div>
      </li>
                  ...
                  <div class="col-lg-7 mx-auto">
                    <div class="p-5 ">
                      <div class="text-center">
                        <h1 class="h4 text-gray-900 mb-4">แก้ไขข้อมูลตลาด</h1>
                      </div>
                      <form class="user" action="code/supmk_form_edit_db.php" method="POST">
                      <input type="hidden" name="mk_id" value="<?php echo $mk_id; ?>">
                        ...
                        <div class="form-group ">
                          ...
                          <input name="mkname" type="text" class="form-control form-control" placeholder="ชื่อตลาด" value="<?= $mk_id; ?>" disabled>
