                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                // echo "<th><button onclick=\"document.getElementById('id01').style.display='block\" href='testt.php?act=edit&ID=$row[0]' class='btn btn-warning btn-xs' >แก้ไข</button></th> ";
                                                //  echo "<th><a href='testt.php?act=edit&ID=$row[0]' class='btn btn-warning btn-xs' >แก้ไข</a></th> ";
                                                echo "<th><a class=\"nav-link dropdown-toggle\" href='testt.php?act=edit&ID=$row[0]' id=\"alertsDropdown\" role=\"button\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\" >แก้ไข</a></th> ";
                                                // echo "<th><button class=\"open-button\" onclick=\"openForm()\" >แก้ไข</button></th> ";
